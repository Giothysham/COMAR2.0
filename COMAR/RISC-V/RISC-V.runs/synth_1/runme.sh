...
HD_PWD='C:/Users/bjorn/COMAR2.0/COMAR/RISC-V/RISC-V.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DataPath_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataPath_tb.tcl
